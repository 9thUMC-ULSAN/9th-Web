...
export default function MovieCard({ movie }: MovieCardProps) {
    ...
    return (
    <div
      className="relative rounded-xl overflow-hidden shadow-lg cursor-pointer w-44 transition-transform duaration-500 hover:scale-105"
    ...
    >
      ...
      {isHovered && (
        <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent backdrop-blur-md flex flex-col justify-center text-white p-4">
            <h2 className='text-lg font-bold.text-center.lenfinf-sung'>{movie.title}</h2>
